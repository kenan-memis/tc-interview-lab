# Optional tasks — What we implemented
...
### Easy #1 — Ask ChatGPT to critique your solution (usability, security, prompt-engineering)

**Category:** Easy

**What we did:** We asked ChatGPT to critique the Interview Lab solution from the **usability**, **security**, and **prompt-engineering** sides. The full critique and the suggested top five improvements (with updated scores) are documented in two separate files under `docs/`:

- **[CRITIQUE.md](CRITIQUE.md)** — Full critique text from ChatGPT (usability, security, prompt-engineering assessment).
- **[CRITIQUE_SUGGESTED_TOP_FIVE_IMPROVEMENTS.md](CRITIQUE_SUGGESTED_TOP_FIVE_IMPROVEMENTS.md)** — Top five suggested improvements and re-evaluation scores after implementing them.

Refer to these documents for the detailed critique and improvement recommendations.
